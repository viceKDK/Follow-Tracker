    ...
    target.innerHTML = profiles.length
      ? profiles.map((profile) => {
          ...
          return `<article class="profile-manager-card${profileMeta.archived ? " archived" : ""}" data-profile="${escapeHtml(profile)}">
            ...
            <div class="profile-manager-actions"><button class="mini-button" data-profile-action="open">Abrir</button><button class="mini-button" data-profile-action="save-label">Guardar etiqueta</button><button class="mini-button" data-profile-action="archive">${profileMeta.archived ? "Desarchivar" : "Archivar"}</button><button class="mini-button" data-profile-action="export">Exportar</button><button class="mini-button danger" data-profile-action="delete">Eliminar</button></div>
          </article>`;
        }).join("")
