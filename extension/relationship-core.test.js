...
test("mantiene los aliases temporales usados por el dashboard 3.1", () => {
  assert.equal(globalThis.transitionHeadline, Relationship.headline);
  assert.equal(globalThis.transitionPriority, Relationship.priority);
});
