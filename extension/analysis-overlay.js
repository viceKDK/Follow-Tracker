(function (root, factory) {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      #ft-v3-overlay .ft3-head{position:sticky;top:0;z-index:2;display:flex;align-items:center;justify-content:space-between;gap:12px;padding:13px 15px;background:linear-gradient(125deg,#283e86,#6658d3);color:#fff}
      ...
      #ft-v3-overlay .ft3-progress{height:6px;margin:9px 0 4px;border-radius:999px;background:#edf0f5;overflow:hidden}.ft3-progress span{display:block;height:100%;width:0;background:linear-gradient(90deg,#2f6df6,#6a55d9);transition:width .2s ease}
